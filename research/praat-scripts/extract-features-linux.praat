...
outputPath$ = "/home/angelgardt/accent-reduction-app/data/features/" + subj$ + "/" + filename$ + ".csv"
...
for thisInterval from 1 to numberOfPhonemes
    ...
    thisStress$ = Get label of interval: 3, thisInterval
  
    # Find the midpoint
    start = Get start point: 2, thisInterval
